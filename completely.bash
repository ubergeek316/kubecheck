...
_kubecheck.sh_completions() {
  ...
  case "$compline" in
    ...
    *)
      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_kubecheck.sh_completions_filter "refresh storage lastreboot processes performance cluster storage cleanstorage network pod")" -- "$cur")
      ;;
